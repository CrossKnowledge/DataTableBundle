 ...
 *   https://datatables.net/download/#dt/jq-3.7.0/dt-2.3.4/cc-1.1.1/date-1.6.1
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.4, ColumnControl 1.1.1, DateTime 1.6.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/jq-3.7.0/dt-2.3.4/cc-1.1.1/date-1.6.1",
