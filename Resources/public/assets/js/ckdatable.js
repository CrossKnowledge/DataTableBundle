!(function () {
  function t(e, n, i) {
    ...
    for (
      var r = "function" == typeof require && require, l = 0;
      l < i.length;
      l++
    )
      a(i[l]);
        ...
        !(function (t) {
          ...
          var r = (function () {
            function e(t) {
              (i(this, e),
                this.setElement(t),
                this.filterableContainer.hasClass("no-init-loading") ||
                  this.initTable());
            }
            return (
              a(e, [
                {
                  key: "initTable",
                  value: function () {
                    void 0 == this.element.data("cktable-initialized") &&
                      (this.initUsingContainer(),
                      this.element.data("cktable-initialized", !0));
                  },
                },
                {
                  key: "reloadTable",
                    ...
                    return (
                      this.table
                        ? this.table.ajax.reload(function () {
                            t.element.trigger("finishRefresh");
                          })
                        : this.initTable(),
                      !1
                    );
                ...
                },
                {
                  ...
                  value: function (t) {
                    ((this.element = t),
                      (this.filterableContainer = this.element.find(
                        ".ck-datatable-filter-container",
                      )),
                      this.initFilterable(),
                      this.initPerPage());
                  },
                },
                {
                  ...
                  value: function () {
                    var t = this.element.find(
                      ".datatable-length-container select",
                    );
                    t.length > 0 && "" != t.val()
                      ? (this.perPage = t.val())
                      : (this.perPage = 10);
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this;
                    (this.filterableContainer.data(
                      "dom-positionning-complete",
                      !1,
                    ),
                      this.filterableContainer
                        .find("button")
                        .on("click", function () {
                          return t.reloadTable();
                        }),
                      this.filterableContainer.hasClass("filter-onchange") &&
                        (this.filterableContainer
                          .find("select")
                          .on("change", function () {
                            return t.reloadTable();
                      ...
                      this.filterableContainer
                        ...
                        .on("keypress", function (e) {
                          if (13 == e.keyCode) return t.reloadTable();
                        }));
                  },
                },
                {
                  ...
                  value: function () {
                    return t(this.data).map(function (t, e) {
                      var n = new Array();
                ...
                },
                {
                  ...
                  value: function () {
                    this.filterableContainer.data(
                      ...
                      (this.filterableContainer.insertAfter(
                        this.element.find(".dom-position-filter-after"),
                      ),
                      this.filterableContainer.data(
                        "dom-positionning-complete",
                        !0,
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    ((this.url = this.element.data("cktable-ajax-url")),
                      ...
                      i = {
                        ajax: {
                          ...
                          type: "POST",
                          data: function (n) {
                            return t.extend(n, e.getFilteredDataValues());
                          },
                        },
                    ...
                    this.element.data("cktable-custom-dom") &&
                      (i.dom = jQuery.parseJSON(
                        this.element.data("cktable-custom-dom"),
                      ));
                    var a = this.element.data("cktable-custom-options");
                    (void 0 != a && (i = t.extend({}, i, a)),
                      (this.table = new DataTable(this.element.find("table"),i)));
                  },
                },
              ]),
              e
          ...
          e.exports = { registerEvents: n, CkDataTable: r };
        })(jQuery);
      },
      {},
    ],
