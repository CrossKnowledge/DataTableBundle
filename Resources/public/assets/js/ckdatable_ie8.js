...
(function ($) {
    ...
    var CkDataTable = function () {
        ...
        _createClass(CkDataTable, [{
            ...
            value: function reloadTable() {
                ...
                if (!this.table) {
                    ...
                    this.table.ajax.reload(function () {
                        _this.element.trigger('finishRefresh');
                    });
                }
                return false;
            }
            ...
            key: 'initFilterable',
            value: function initFilterable() {
                var _this2 = this;

                this.filterableContainer.data('dom-positionning-complete', false);
                this.filterableContainer.find('button').on('click', function () {
                    return _this2.reloadTable();
                });

                if (this.filterableContainer.hasClass('filter-onchange')) {
                    this.filterableContainer.find('select').on('change', function () {
                        return _this2.reloadTable();
                    });
                    this.timer = false;
                    this.filterableContainer.find('input').on('keyup', function () {
                        if (_this2.timer != false) {
                ...
                this.filterableContainer.find('input').on('keypress', function (e) {
                    if (e.keyCode == 13) {
                        return _this2.reloadTable();
                    }
                });
            ...
            value: function formatColumnOption() {
                var t = [];
            ...
            key: 'getFilteredDataValues',
            value: function getFilteredDataValues() {
                var t = {};
            ...
            key: 'tableDrawCallback',
            value: function tableDrawCallback() {
                //Reposition filter
            ...
            key: 'initUsingContainer',
            value: function initUsingContainer() {
                var _this3 = this;

                this.url = this.element.data('cktable-ajax-url');

                this.columns = this.element.data('cktable-columns');
                var colList = this.formatColumnOption();
                ...
                var options = {
                    ajax: {
                        ...
                        data: function data(d) {
                            return $.extend(d, _this3.getFilteredDataValues());
                        }
                    },
                    drawCallback: function drawCallback(settings) {
                        _this3.tableDrawCallback();
                    },
