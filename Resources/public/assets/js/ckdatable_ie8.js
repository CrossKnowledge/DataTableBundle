...
(function ($) {
   ...
   * - event listeners
   */
  var CkDataTable = /*#__PURE__*/function () {
    /**
    ...
    _createClass(CkDataTable, [{
      ...
      value: function formatColumnOption() {
        ...
        for (var i in this.columns) {
          var def = $.extend({}, this.columns[i]); //def.data = i;
